...
-- low lying sand
-- This should try to ensure the starting tile is land.
...
data.raw.turret['small-worm-turret'].autoplace = worm_autoplace(1, 0.6, 'z', true)
data.raw.turret['medium-worm-turret'].autoplace = worm_autoplace(1, 0.5, 'y', true)
if data.raw.turret['bob-big-explosive-worm-turret'] then
  data.raw.turret['bob-big-explosive-worm-turret'].autoplace = worm_autoplace(1.5, 0.3, 'v', false)
end
...
data:extend({
  ...
  },
  {
    ...
    name = 'default-factorio-noise'
  },
  {
    type = 'noise-expression',
    name = 'speaceblock-noise',
...
data.raw['noise-expression']['default-factorio-noise'].expression = data.raw['noise-expression']['elevation'].expression
data.raw['noise-expression']['speaceblock-noise'].expression =
  noise.define_noise_function(function(x, y, tile, map)
      x = x + 40000
      y = y

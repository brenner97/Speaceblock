...
},
{
  type = "technology",
  name = "sb-startup1",
  icon = "__SpeaceBlock__/graphics/technology/ore.png",
  icon_size = 128,
  effects = {
...
},
{
  type = "technology",
  name = "sb-startup2",
  icon = "__SpeaceBlock__/graphics/technology/basic-circuit-board.png",
  icon_size = 128,
  effects = {
...
--[[
{
  type = "technology",
  name = "sb-startup3",
  icon = "__SpeaceBlock__/graphics/technology/coal.png",
  icon_size = 128,
  effects = {
...
]]--
{
  type = "technology",
  name = "sb-startup4",
  icon = "__SpeaceBlock__/graphics/technology/lab.png",
  icon_size = 128,
  effects = {

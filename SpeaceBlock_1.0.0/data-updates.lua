...
log("DDD" .. serpent.block(data.raw.technology["slag-processing-2"]))
...
bobmods.lib.tech.remove_science_pack("slag-processing-2", "chemical-science-pack")
...
-- Remove chemical-science-pack dep from thermal-water-extraction-2 to avoid compatability issues.
bobmods.lib.tech.remove_science_pack("thermal-water-extraction-2", "chemical-science-pack")
bobmods.lib.tech.remove_science_pack("thermal-water-processing", "chemical-science-pack")
...
data.raw.technology['electronics'].prerequisites = {
  'angels-solder-smelting-1', 'automation', 'slag-processing-1', 'angels-coal-processing'
}
